...
public sealed class IndexOfSequenceTests
{
    ...
    public void Returns_index_of_existing_sequence_for_start_and_count(IList<long> longs, long[] sequence,
    ...
    public void Returns_minus_one_for_start_and_count_if_sequence_not_found(IList<long> longs, long[] sequence,
        int start, int count)
    {
